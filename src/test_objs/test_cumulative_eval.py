...
class TestCumulativeEvaluator():
    ...
    def __init__(self):
        ...
        self.model_obj.load_and_set_model(2, 2,
                                          model_path=CUMULATIVE_TEST_MODEL_PATH,
                                          type="v2")
    ...
    def test_pixel_roc_curve(self):
        pred_logit_dist = self.model_obj.get_rescaled_chaos_region_logit_scan(self.test_region,
                                                                              crop_size=384)
        ...
        auc, fprs, tprs = self.eval_obj.calc_pixel_auc(self.lbl_crop,
                                                       pred_logit_dist,
                                                       thresh_count=50,
                                                       thresh_min=0,
                                                       thresh_max=1)
